...
public class HotelValidator : AbstractValidator<Hotel>
{
    public HotelValidator()
    {
        ...
        RuleFor(p => p.Longitude).NotEmpty().ScalePrecision(6, 8).WithMessage("The Longitude must have 6 digits after the decimal point and 1 digit in front of it");
        RuleFor(p => p.Latitude).NotEmpty().ScalePrecision(6, 8).WithMessage("The Latitude must have 6 digits after the decimal point and 1 digit in front of it");
